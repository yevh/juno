...
func getInitTxns(depClasses []core.Cairo0Class) ([]core.Transaction, error) {
	...
	deployDummyTokenTransaction := core.DeployAccountTransaction{
		DeployTransaction: core.DeployTransaction{
			TransactionHash:     new(felt.Felt).SetBigInt(big.NewInt(22688876470218804543887986415455328819098091743988100398197353790124740200)),
			...
			ClassHash:           big.NewInt(3531298130119845387864440863187980726515137569165069484670944625223023734186),
